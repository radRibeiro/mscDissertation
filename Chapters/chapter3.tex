...
\section{Possibilidades de optimização} % (fold)
\label{abordagem}
...
Face à possibilidade de não existir nenhuma versão do CUDA para programar paralelizações em Free Pascal%citar resposta stackOverflow 
...
%Introduzir figura do cuda sobre um array com indexacao de threads e blocos

...
\title[Protein docking GPU acceleration]{Protein docking GPU acceleration}
\subtitle{Science is beautiful}

% Autor
% use [f] for female and [m] for male
\authorname[m]{Ricardo Alexandre do Rosário Ribeiro}{Ricardo Ribeiro}
...
% use [f] for female and [m] for male
\adviser[m]{Ludwig Krippahl}{Full Professor}{\\& NOVA University of Lisbon} 
...
% use [f] for female and [m] for male
\coadviser[m]{Hervé Paulino}{Associate\\& Professor}{NOVA University of Lisbon}
